...
public abstract class BaseDiscordApiController {
    ...
    protected BaseDiscordApiController(
    ...
    protected HttpHandler.HttpResponse<DiscordAccessTokenResponse> getAccessToken(String code) {
    ...
    protected HttpHandler.HttpResponse<DiscordIdentityResponse> getUserInfo(String accessToken) {
        final HttpHeaders headers = new HttpHeaders();
