...
insert into minigames_account_session
(id, game_account_id, playtime, first_join, last_join, online, updated_at)
values
(1, 1, 60000, '2026-01-01 10:00:00', '2026-01-01 10:00:00', true, '2026-01-01 10:00:00'),
(2, 2, null,  '2026-01-01 10:00:00', null, false, '2026-01-01 10:00:00')
ON conflict do nothing;
...
SELECT setval('minigames_account_session_id_seq', (SELECT MAX(id) FROM minigames_account_session));